...
public final class ActivityBoardBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialToolbar boardBar;

  @NonNull
  public final RecyclerView recyclerView;

  private ActivityBoardBinding(@NonNull LinearLayout rootView, @NonNull MaterialToolbar boardBar,
      @NonNull RecyclerView recyclerView) {
    this.rootView = rootView;
    this.boardBar = boardBar;
  ...
  public static ActivityBoardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.board_bar;
      MaterialToolbar boardBar = ViewBindings.findChildViewById(rootView, id);
      if (boardBar == null) {
        break missingId;
      }
      ...
      return new ActivityBoardBinding((LinearLayout) rootView, boardBar, recyclerView);
    }
